...
export default function RandomMatchAnimation({ isSearching, onStart, onCancel, onlineCount = 0 }) {
  const personIcon = (
  ...
  return (
    <div className="match-stage">
      ...
      {!isSearching && (
        <div className="mt-8 px-4 py-2 bg-[rgba(23,20,15,0.04)] rounded-full border border-[rgba(23,20,15,0.08)] flex items-center justify-center gap-2.5" style={{ zIndex: 10 }}>
          <span className="relative flex h-2.5 w-2.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-green-500 shadow-sm"></span>
          </span>
          <span className="text-[11px] font-black text-echo-text tracking-widest pt-0.5">
